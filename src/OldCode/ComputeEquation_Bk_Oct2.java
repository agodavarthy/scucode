...
public class ComputeEquation_Bk_Oct2 {
...
//		areaCorpusMaptemp = new HashMap<>();
    ...
    private void computeBaseLineProbs(String areaname_Kt, double firstProb, Map<String, Integer> areaCorpusMapBaseline, BufferedWriter bw2) throws IOException{
//    	System.out.println("Getting the area map for area = " + areaname_Kt);
    	getAreaTerms(areaname_Kt, areaCorpusMapBaseline);
//		System.out.println("Length of areaCorpusMapBaseline = " + areaCorpusMapBaseline.size());
		int totFreq = calculateTotFreq(areaCorpusMapBaseline);
		double alpha = 0.85;
    	for (Object term : testCorpusMapBaseline.keySet()) {
			double wordProb = 0.0;
			TestTermParams ttp = testCorpusMapBaseline.get(term);
			int word_freq = ttp.freq;
			double secondProb = ttp.prob;
			Object look_term = areaCorpusMapBaseline.get(term);
			if (look_term != null) {
				secondProb = alpha * 1 / totFreq;
			} else {
				secondProb = (1 - alpha) * 1
						/ totFreq;
			}
			secondProb *= word_freq;
			bw2.write("Kt = " + areaname_Kt + "\tword = " + term + "\n");
			bw2.write("P(Kt/r) = " + firstProb + "\tP(Kt+1/Kt) = " + secondProb + "\n");
...
//    }
	...
	public static void main(String args[]) throws IOException, ParseException {
		...
		ComputeEquation_Bk_Oct2 resAreaScore = new ComputeEquation_Bk_Oct2();
		resAreaScore.Init();
		...
		resAreaScore.getTestCorpus("2008");
		int totFreqTest = 0;
...
//							resAreaScore.computeBaseLineProbs(areaname_Kt, firstProb, resAreaScore.areaCorpusMapBaseline, bw2);
...
//										totFreq = resAreaScore.calculateTotFreq(resAreaScore.areaCorpusMap);
										...
										for (Object s : doc_set1) {
											...
											if (s_integer != hits_Kt[i].doc) {
												...
												System.out.println("Computing normal prob for area = " + areaname_Ktplus);
//												resAreaScore.getAreaTerms(areaname_Ktplus, resAreaScore.areaCorpusMap);
//												totFreq = resAreaScore.calculateTotFreq(resAreaScore.areaCorpusMap);
												break;
											}
...
//										bw1.write("P(Kt/r) = " + firstProb + "\tP(Kt+1/Kt) = " + secondProb + "\tP(w/Kt+1) = " + thirdProb + "\n");
...
//									System.out.println("Done with test word parsing");
						...
						for (Object term : resAreaScore.testCorpusMap.keySet()) {
							TestTermParams ttp1 = resAreaScore.testCorpusMap.get(term);
//							TestTermParams ttp2 = resAreaScore.testCorpusMapBaseline.get(term);
//							System.out.println(term + " prob = " + ttp1.prob);
//							System.out.println(term + " prob = " + ttp2.prob);
							cummResIntPerProb += Math.log(ttp1.prob);
							researcherProb *= ttp1.prob;
...
//							resAreaScore.computeBaseLineProbs(areaname_Kt, firstProb, resAreaScore.areaCorpusMapBaseline, bw2);
							int totFreq = 0;
							resAreaScore.getAreaTerms(areaname_Kt, resAreaScore.areaCorpusMap);
							totFreq = resAreaScore.calculateTotFreq(resAreaScore.areaCorpusMap);
...
//								bw2.write("P(Kt/r) = " + firstProb + "\tP(w/Kt+1) = " + thirdProb + "\n");
...
//							researcherProbBaseline *= ttp.prob;
//						}
