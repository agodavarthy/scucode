...
public class baselineComputationV1 {
...
//		areaCorpusMaptemp = new HashMap<>();
    ...
    private void computeBaseLineProbs(String areaname_Kt, double firstProb, Map<String, Integer> areaCorpusMapBaseline) throws IOException{
...
//    }
	...
	public static void main(String args[]) throws IOException, ParseException {
		...
		baselineComputationV1 resAreaScore = new baselineComputationV1();
		resAreaScore.Init();
...
//		resAreaScore.openQueryFile();
		...
		String line = null;
        BufferedWriter bw = new BufferedWriter(new FileWriter("/home/archana/SCU_projects/research_changes/lucene/probabilities"));
		try {
			while ((line = br.readLine()) != null) {
...
//						System.out.println(cummKtProb);
						for (int i = 0; i < hits_Kt.length; i++) {
							...
							resAreaScore.computeBaseLineProbs(areaname_Kt, firstProb, resAreaScore.areaCorpusMapBaseline);
							...
							for (Object doc_set : resAreaScore.doc_sim_dic.keySet()) {
								...
								if (doc_set1.contains(docno)) {
									...
									for (Object term : resAreaScore.testCorpusMap.keySet()) {
										...
										thirdProb *= word_freq;
										bw.write("Kt = " + areaname_Kt + "\tKtPlus = " + areaname_Ktplus + "\tword = " + term + "\n");
										bw.write("P(Kt/r) = " + firstProb + "\tP(Kt+1/Kt) = " + secondProb + "\tP(w/Kt+1) = " + thirdProb + "\n");
